...
class BinarySearchTree(Tree):
    ...
    def lca(self, node1, node2):
        ...
        c = self._root
        while c is not None:
            if (node1._element < c._element and 
                node2._element < c._element
                ):
                c = c._left

            elif (node1._element > c._element and 
                  node2._element > c._element
                  ):
                c = c._right
...
def main():
    ...
    print(bst.lca(node_6, node_9)._element)  # should print 7
    print(bst.lca(node_6, node_7)._element)  # should print 7
    print(bst.lca(node_3, node_20)._element)  # should print 10
