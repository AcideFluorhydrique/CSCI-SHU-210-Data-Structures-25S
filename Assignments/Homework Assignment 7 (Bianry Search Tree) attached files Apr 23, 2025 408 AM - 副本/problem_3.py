...
class BinarySearchTree(Tree):
    ...
    def kth_largest(self, k):
        ...
        """Implement the member kth_largest(self, k), 
        which returns the kth largest element in a Binary Search Tree. 
        If k is too large, return the smallest element’s node within the tree. 
        If k is too small, return the largest element’s node in the tree.
        """
        ...
        _max = self.last()
        while k > 1 and k <= len(self):
            _max = self.before(_max)
            k -= 1
        return _max
        pass
...
def main():
    ...
    print(bst.kth_largest(3)._element)  # should print 12
    print(bst.kth_largest(7)._element)  # should print 2
    print(bst.kth_largest(9)._element)  # should print 2
